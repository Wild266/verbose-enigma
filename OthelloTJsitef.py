...
#  print(tkn, lowerBnd, upperBnd)
 ...
 if len(pmoves)==0 and len(epmoves): # if game is over
   ab=midgamealphabeta(brd, eTkn, -upperBnd, -lowerBnd, depth+1,pre)
   return [-ab[0]]+ab[1:]+[-1]
...
#  print(tkn, lowerBnd, upperBnd)
 ...
 if len(pmoves)==0 and len(epmoves)==0:
   ...
   return [(((tkncnt/100)+len(pmoves)+(10*((brd[0]==tkn)+(brd[7]==tkn)+(brd[63]==tkn)+(brd[56]==tkn))))-((etkncnt/100)+len(epmoves)+(10*((brd[0]==eTkn)+(brd[7]==eTkn)+(brd[63]==eTkn)+(brd[56]==eTkn)))))] # if tkn can't move
 if len(pmoves)==0 and len(epmoves): # if game is over
   ab=midgamealphabeta(brd, eTkn, -upperBnd, -lowerBnd, 1,0)
   return [-ab[0]]+ab[1:]+[-1]
 best = [lowerBnd-1] # guarantees best will be set
 if pmoves&{0,7,56,63}:
   lpmoves=list(pmoves)
...
#  print(tkn, lowerBnd, upperBnd)
 ...
 pmoves=possiblemoves(brd,tkn)
 epmoves=possiblemoves(brd,eTkn)
 if depth>=(midgamedepth+8) or (len(pmoves)==0 and len(epmoves)==0):
   tkncnt = brd.count(tkn)
   etkncnt = brd.count(eTkn)
   if tkncnt==0:
      return [-99999]
...
#  print(tkn, lowerBnd, upperBnd)
 ...
 pmoves=possiblemoves(brd,tkn)
 epmoves=possiblemoves(brd,eTkn)
 if depth>=(midgamedepth+10) or (len(pmoves)==0 and len(epmoves)==0):
   tkncnt = brd.count(tkn)
   etkncnt = brd.count(eTkn)
   if tkncnt==0:
      return [-99999]
...
#  print(tkn, lowerBnd, upperBnd)
 ...
 pmoves=possiblemoves(brd,tkn)
 epmoves=possiblemoves(brd,eTkn)
 if depth>=(midgamedepth+12) or (len(pmoves)==0 and len(epmoves)==0):
   tkncnt = brd.count(tkn)
   etkncnt = brd.count(eTkn)
   if tkncnt==0:
      return [-99999]
...
#  print(tkn, lowerBnd, upperBnd)
 ...
 pmoves=possiblemoves(brd,tkn)
 epmoves=possiblemoves(brd,eTkn)
 if depth>=(midgamedepth+14) or (len(pmoves)==0 and len(epmoves)==0):
   tkncnt = brd.count(tkn)
   etkncnt = brd.count(eTkn)
   if tkncnt==0:
      return [-99999]
